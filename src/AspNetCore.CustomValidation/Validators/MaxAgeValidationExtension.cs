...
namespace AspNetCore.CustomValidation.Validators
{
    public static class MaxAgeValidationExtension
    {
        ...
        public static ValidationResult ValidateMaxAge(this ValidationContext validationContext,
            string propertyName, int years, int months, int days, string errorMessage = null)
        {
            ...
            if (years > 0 || months > 0 || days > 0)
            {
                ...
                {
                    errorMessage = errorMessage ?? $"Maximum age can be {(years > 0 ? years + " years" : "")} {(months > 0 ? months + " months" : "")} {(days > 0 ? days + " days" : "")}.";
