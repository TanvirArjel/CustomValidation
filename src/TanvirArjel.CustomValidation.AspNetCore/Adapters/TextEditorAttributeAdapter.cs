...
{
    internal class TextEditorAttributeAdapter : AttributeAdapterBase<TextEditorAttribute>
    {
        private IStringLocalizer _stringLocalizer;

        public TextEditorAttributeAdapter(TextEditorAttribute attribute, IStringLocalizer stringLocalizer)
